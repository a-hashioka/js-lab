...
export const kuen: ShapeDefinition = {
  id: "kuen",
  title: "Kuen Surface",
  hideVertices: true,
  desc: [
  ...
  formulas: [
    {
      ...
      eq: "\\begin{cases} x = \\frac{2(\\cos u + u \\sin u) \\sin v}{d} \\\\ y = \\frac{2(\\sin u - u \\cos u) \\sin v}{d} \\\\ z = \\ln \\tan \\frac{v}{2} + \\frac{2 \\cos v}{d} \\end{cases}",
    },
